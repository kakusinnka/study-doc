...
![身份和访问管理](../images/gcp-iam.png)  
![资源层次结构级别定义信任边界](../images/resource-hierarchy2.png)  
...
### 规划和配置计算资源
![](../images/IasS-gce-gke.png)  
![](../images/PasS-gae-gcr-gcf.png)

### 规划和配置数据存储选项
![](../images/comparing-data-storage-and-database-options.png)  
![](../images/comparing-storage-options-use-case.png)  
[存储类别](https://cloud.google.com/storage/docs/storage-classes?hl=zh-cn)

### 规划和配置网络资源
![](../images/gcp-lb-options.png)  
![](../images/gcp-lb-summary.png)  
...
![磁盘选项摘要](../images/gce-disk-options.png)  
![托管实例组](../images/managed-instance-groups.png)  
